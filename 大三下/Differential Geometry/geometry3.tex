...
\begin{solution}
    ...
    \begin{align*}
        ...
        \bd{r}''(\varphi) =&\ (2(\cos^2\varphi-\sin^2\varphi), -4\sin\varphi\cos\varphi, -\cos\varphi),\\
        \bd{r}'''(\varphi) =&\ (-8\sin\cos\varphi, 4(\sin^2\varphi - \cos^2\varphi), \sin\varphi).
    \end{align*}
    取$\varphi\to 0^+$有$\bd{r}' = (0,1,0),\ \bd{r}'' = (2, 0, -1),\ \bd{r}''' = (0, -4, 0),\ |\bd{r}'\times \bd{r}''| = \sqrt{5},\ (\bd{r}',\bd{r}'',\bd{r}''') = 0$则
    \begin{equation*}
        \kappa(0,0,1) = \frac{|\bd{r}'\times \bd{r}''|}{|\bd{r}'|} = \sqrt{5},\quad \tau(0,0,1) = 0.
    \end{equation*}
\end{solution}
