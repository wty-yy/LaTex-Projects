...
\begin{figure}[htbp]
    \centering
    \hspace*{-1.5cm}
    \includegraphics[scale=0.6]{C:/Users/admin/Documents/GitHub/CVPR_homeworks/code/hw2/CVPR2_note.figure/向前变换.png}
    \caption{向前变换\label{fig-0}}
\end{figure}
\begin{figure}[htbp]
    \centering
    \hspace*{-1.5cm}
    \includegraphics[scale=0.6]{C:/Users/admin/Documents/GitHub/CVPR_homeworks/code/hw2/CVPR2_note.figure/几何变换实验.png}
