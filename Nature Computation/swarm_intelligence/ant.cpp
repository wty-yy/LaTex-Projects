...
const int maxt = 2;         // 迭代重复次数
const double ALPHA = 1;     // 信息素比重
const double BETA = 5;      // 启发信息(城市距离)比重
const double EPS = 1e-8;    // 浮点数精度
const double RHO = 0.5;     // 信息素残留率
const double Q = 10;        // 信息素更新时相关常数
int n, m = 10;
